...
<html lang="en">
  ...
  <a href="/admin/news" class="nav-link active">
      ...
      <main class="app-main">
        ...
        <div class="app-content">
          ...
          <div class="container-fluid">
            ...
            <?php else: ?>
              <!-- Konten dashboard statis (tidak diubah) -->
              <!--begin::Row-->
              <div class="row">
                <!--begin::Col-->
                      ...
                      <div class="direct-chat-messages">
                        ...
                        <div class="direct-chat-msg">
                          <div class="direct-chat-infos clearfix">
                            <span class="direct-chat-name float-start"> Muhammad Revaldo Andika </span>
    ...
    <?php echo $__env->make('layouts.admin.scripts', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->yieldContent('scripts'); ?>
    <!--end::Script-->
  </body>
  <!--end::Body-->
</html>
<?php /**PATH D:\laragon\www\PortalNews-part1\resources\views/Layouts/admin/master.blade.php ENDPATH**/ ?>